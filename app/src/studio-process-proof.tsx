...
export function StudioProcessProof({ enabled }: { enabled: boolean }) {
  ...
  return <section id="approach" className="process-proof wrap chapter" aria-labelledby="approach-title">
    <div className="proof-intro"><span className="kicker">Від задуму до ролика</span><h2 id="approach-title"><Words text="Спочатку бачите ідею."/><br/><em><Words text="Потім — ролик."/></em></h2><p>Узгоджуємо сценарій і ключові кадри до виробництва. Ви можете оцінити напрям, поки його ще легко змінити.</p><div className="proof-promise"><span>Ви приносите продукт.</span><span>Ми — ідею, сценарій, монтаж і звук.</span></div></div>
