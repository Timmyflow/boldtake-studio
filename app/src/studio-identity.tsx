...
const questions = [
  {
    ...
    answer:
      "Рекламний ролик 10–15 секунд — від 5 000 грн, 20–30 секунд — від 10 000 грн. Пакети з кількох роликів — від 9 000 грн. У вартість входять сценарій, генерації, монтаж, звук та одна хвиля правок. Остаточну суму узгоджуємо за сценарієм і обсягом до початку роботи.",
  },
  {
